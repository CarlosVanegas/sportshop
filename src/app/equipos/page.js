...
export default function EquiposPage() {
    ...
    const featuredProducts = [
        {
            id: 1,
            name: "Balón de Fútbol Adidas Champions League",
            price: 29.99,
            image: "/placeholder.svg?height=300&width=300&query=football",
            category: "futbol",
        },
        {
            id: 2,
            ...
            price: 39.99,
            image: "/placeholder.svg?height=300&width=300&query=basketball",
            category: "baloncesto",
        },
        {
            id: 3,
            ...
            price: 89.99,
            image: "/placeholder.svg?height=300&width=300&query=dumbbells",
            category: "fitness",
        },
        {
            id: 4,
            ...
            price: 149.99,
            image: "/placeholder.svg?height=300&width=300&query=tennis%20racket",
            category: "tenis",
        },
    ]
        ...
        <div className="bg-white">
            ...
            <section className="relative bg-black">
                <div className="relative h-[500px] w-full overflow-hidden">
                    <Image
                        src="/placeholder.svg?height=500&width=1920&query=sports%20equipment%20collection"
                        alt="Colección de equipos deportivos"
                        fill
                    ...
                    <div className="absolute inset-0 flex items-center">
                        <div className="container mx-auto px-4">
                            <div className="max-w-xl">
                                <h1 className="text-5xl font-bold text-white mb-4 drop-shadow-md">EQUIPOS DEPORTIVOS</h1>
            ...
            <section className="py-16 bg-neutral-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12">CATEGORÍAS DE EQUIPOS</h2>

                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        {subcategories.map((category) => (
                            <Link key={category.id} href={`/equipos/${category.id}`} className="group">
                                <div className="relative h-60 rounded-lg overflow-hidden">
                                    <Image
                                        src={`/placeholder.svg?height=240&width=200&query=${category.name}%20equipment`}
                                        alt={category.name}
                                        fill
            ...
            <section id="featured" className="py-16">
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <Link
                            href="/productos?categoria=equipos"
            ...
            <section className="py-16 bg-neutral-900 text-white">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="bg-neutral-800 p-8 rounded-xl flex items-center justify-center h-40">
                        ...
                        <div className="bg-neutral-800 p-8 rounded-xl flex items-center justify-center h-40">
                            <h3 className="text-2xl font-bold">Under Armour</h3>
                        </div>
                    </div>
                </div>
            </section>
